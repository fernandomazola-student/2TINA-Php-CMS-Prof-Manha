                    ...
                    <div class="col-lg-12">
                         ...
                         <?php
                          ...
                          if (isset($_POST['update'])) {
                            ...
                            if (!$update_post) {
                              ...
                              <a href='../admin/edit_post.php?edit={$the_post_id}'>
                        ...
                        <form action="" method="post" enctype="multipart/form-data">
                          ...
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="post_autor" value="<?php echo  $post_autor; ?>">
                          </div>
                          ...
                          <div class="form-group">
                            ...
                            <img src="../images/<?php echo $post_imagem;?>" width="300px;">
                          ...
                          <div class="form-group">
                            ...
                            <textarea class="form-control" name="post_conteudo" cols="30" rows="10"><?php echo  $post_conteudo;?></textarea>
                          </div>
